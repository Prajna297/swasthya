  ...
  return (
    <section className='relative overflow-hidden'>
      ...
      <div className='absolute top-20 left-32 flex items-center p-10 space-x-20'>
        <motion.div whileInView={{ scale: [0.5, 1], x: [-100, 0], opacity: [0, 1], transition: { duration: 1 } }}>
          <Image src='/banner.svg' width={1600} height={1600} className='shadow-lg rounded-full p-5 border-2 bg-teal-300' />
        </motion.div>

        <motion.div
          className='flex flex-col pr-6'
          whileInView={{ scale: [0.8, 1], x: [100, 0], opacity: [0, 1], transition: { duration: 1 } }}
        >
