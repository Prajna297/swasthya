    ...
    <nav className='fixed top-0 z-50 w-full flex py-3 px-6 bg-white bg-opacity-20 backdrop-blur-sm justify-between items-center'>
      ...
      <div className='flex space-x-4 text-teal-600'>
        ...
        <button
          ...
          className='text-white text-base bg-teal-600 py-3 px-4 mx-2 border-swasthya shadow-sm hover:shadow-md shadow-teal-300 hover:shadow-teal-400 scale-on-hover-sm flex space-x-2 items-center'
        >
          Login
